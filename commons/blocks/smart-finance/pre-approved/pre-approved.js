...
import {
  getAllLoanOffers, getLoanScheme, getPreApprovedLoanOffers, selectedLoanOffer,
...
export default async function decorate(block) {
  ...
  const response = await getAllLoanOffers('5');
  let jsonData = [];
  if (response.success) {
  ...
  const preapprovedResponse = await getPreApprovedLoanOffers(body);
            ...
            <div class="pageTitle">
                ...
                <div class="eligibleBank">
                    ...
                    <div class="download-offer-wrapper">
                        <a class="download_Offer" style="">${download}</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="calcEmiBox">
                                ...
                                <div class="calcRangeSlider">
                                    <div class=" text calcRangeSlider-wrapper">
                                        ${down}
                                        <div class="irs-single-get " contenteditable="true">175 486</div>
                                    </div>
                                    <input type="range" id="demo_3n" class="custom-slider" min="0" max="5000000" step="1"" readonly="">
                                ...
                                <div class="flexible-emi">
                                  <h5 class="flexible-emi__title">Flexible EMI Option(s)</h5>
                                    ...
                                    <input type="radio" id="ballon-finance" name="ballon" class="custom-control-input radio-style">
                                    <label class="custom-control-label" for="ballon-finance">
                                        Balloon Financing
                        ...
                        <div class="rightTableMain">
                            ...
                            <div class="rightTable">
                                ...
                                <ul  id="loanList" class="bankloadofferList tableListSec scroll scroll1" style="height: 680px;">
                                    <li class="lists">
                                        ...
                                        <div class="bnkLoanRowBx full-basis">
                                            <input type="checkbox" class="custom-check"><label
                                                class="addToCompareCheck customCheckBox" style="display: block;">Add to
                                                compare </label>
                                ...
                                <div class="pageButton">
                                    <div class="whiteButton"><a class="backbtn">${back}</a></div>
                                    <div class="blackButton" id="comapre-btn"><a href="javascript:(void)" class="compareLoan"
                                            style="">Compare</a></div>
                                </div>
                            </div>
                            ...
                            <div class="nfLoanDetailpointer">
                                <ul>
                                    ...
                                    <li><span style="color: #444444;">Processing Fees: @ 0.25% of loan amount, Minimum -
                                            Rs. 1,000/- Maximum- Rs. 1,500/- + Taxes</span></li>
  ...
  function handleLoanAmountEdit(listItem, loan) {
    ...
    inputField.value = loan['loan-amount'];
  ...
  function handleDownPaymentEdit(listItem, loan) {
    ...
    inputField.value = loan.down_payment;

    okButton.addEventListener('click', () => {
      const newValue = parseInt(inputField.value, 10);
      const maxDownPayment = parseInt(loan.max_down_payment, 10);
  ...
  function populateLoanList(data) {
    ...
    <div class="bnkLoanRowBx">
        ...
        <div class="edit-wrapper">
            <a class="loanamount" href="javascript:void(0);">₹ ${loan.bank_offer_amount}</a>
    ...
    <div class="bnkLoanRowBx">
        <label class="row-title">Min. Down Payment</label>
        <div class="edit-wrapper">
            <a class="downpayment" href="javascript:void(0);">₹ ${loan.down_payment}</a>
    ...
    <div style="width:100%;display:flex;align-items:center;justify-content:flex-end">
        ...
        <label class="addToCompareCheck customCheckBox" style="display: block;">Add to compare</label>
    ...
    <div class="flexible-emi-offer" style="display: none">
      ...
      listItem.querySelector('.apply_loan').addEventListener('click', async () => {
        const requestBody = {
          enquiry_id: 'NX-28112024-531056311',
          mobile: '8700976002',
          ...
          interest_rate_type: data[index].interest_rate_type || '',
  ...
  document.getElementById('comapre-btn').addEventListener('click', () => {
    const checkedOffers = document.querySelectorAll('.full-basis .custom-check:checked');
    const checkedCount = checkedOffers.length;

    if (checkedCount > 3) {
      document.getElementById('bank_validation_popup').classList.add('fade-in');
      document.getElementById('bank_validation_popup').style.display = 'flex';
      ...
      currentUrl = `${currentUrl.substring(0, currentUrl.lastIndexOf('/'))}/nexafinance-loan-compare`;
  ...
  const radioButton = document.getElementById('ballon-finance');
  ...
  // ------------------Pre-ApprovedTab Functionality End-----------------------//
  // --------------------------Car Deatials Mock API Start----------------------//
  const carDetail = {
    carRoad: [
      {
        'car-detail': 'MARUTI IGNIS DELTA 1.4L 5MT',
        'road-price': '₹ 722641',
      },
    ],
  };
  ...
  function populateCarDetails() {
    ...
    const car = carDetail.carRoad[0];

    // Update the HTML content
    document.getElementById('carDetail').textContent = car['car-detail'];
    document.getElementById('roadPrice').insertAdjacentHTML('afterbegin', car['road-price']);
  }

  // Call the function to populate data
  populateCarDetails();
  // ----------------------Car details mock api end----------------------------------------//
  ...
  function filterByTenure(tenureValue) {
    if (tenureValue === 'All') {
      // Render all loans if 'All' is selected
      populateLoanList(jsonData);
    } else {
      // Filter loans where tenure matches the selected tenure value
      const filteredData = jsonData
        .filter((loan) => parseInt(loan.tenure, 10) === parseInt(tenureValue, 10));
      populateLoanList(filteredData);
    }
  }
  // Add click event listener to each tenure element
  document.querySelectorAll('.tenure').forEach((loanTenure) => {
    loanTenure.addEventListener('click', function loanField() {
      ...
      const tenureValue = this.textContent.trim();
