...
export function htmlStringToPreactNode(htmlString) {
  ...
  return convert(doc.body.firstChild);
}
...
export default async function decorate(block, routes) {
  ...
  function MultiStepForm() {
    ...
    const context = { activeRoute, setActiveRoute, formState, updateFormState, bankResponse, setBankResponse, handleSetActiveRoute };
    ...
    useEffect(() => {
      // Need to implement actual handling of form state changes, this is just for demo purposes
    }, [formState]);
